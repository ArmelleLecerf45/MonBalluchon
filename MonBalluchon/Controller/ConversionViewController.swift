...
class ConversionViewController: UIViewController, UITextFieldDelegate {
   ...
   let rateChoice = ["$ AR", "$ AUS", "₿ BTC", "$ CA", "F CH","¥ CN", "DA DZD",  "£ GB",  "ש ISL", "¥ JP", "₽ RUS","$ US"  ]
       

       
   // MARK: - IBOutlet
    @IBOutlet weak var sumToConvert: UITextField!
  ...
  // MARK: - viewDidLoad & presentAlert
        ...
        // MARK: - IBAction : button control
            ...
            private func updateResultLabelText() {
                ...
                ConversionService.shared.getChangeRates { (true, searchRate) in
